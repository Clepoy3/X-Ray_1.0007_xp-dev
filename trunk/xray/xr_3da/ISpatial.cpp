...
void			ISpatial_DB::insert		(ISpatial* S)
{
	...
	if (!bValid)	
	{
		...
		if	(O)			Debug.fatal(DEBUG_INFO,"Invalid OBJECT position or radius (%s)",O->cName().c_str()); // https://github.com/OpenXRay/xray-16/commit/3a788d060033f84e09aca05f3729869d07b9f4a4
		else			{
