...
//		.def("armor",						&CScriptGameObject::Armor)
		...
		.def("get_ammo_in_gl",				&CScriptGameObject::get_ammo_in_gl)
		.def("set_ammo_in_gl",				&CScriptGameObject::set_ammo_in_gl)
		.def("get_magazine_ammo_type",		&CScriptGameObject::get_magazine_ammo_type)
		.def("set_magazine_ammo_type",		&CScriptGameObject::set_magazine_ammo_type)
		.def("get_gl_ammo_type",			&CScriptGameObject::get_gl_ammo_type)
		.def("set_gl_ammo_type",			&CScriptGameObject::set_gl_ammo_type)
