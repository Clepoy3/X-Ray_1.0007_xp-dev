...
{
	{
		...
		static_assert(a::value, "Client_class_must_be_derived_from_the_CLIENT_BASE_CLASS");
	}
	{
		typedef object_type_traits::is_base_and_derived<SERVER_BASE_CLASS,_server_type> a;
		static_assert(a::value, "Server_class_must_be_derived_from_the_SERVER_BASE_CLASS");
	}
...
{
	{
		...
		static_assert(a::value || b::value, "Class_must_be_derived_from_the_CLIENT_BASE_CLASS_or_SERVER_BASE_CLASS");
	}
	add					(
		xr_new<
			CObjectItemSingle<
