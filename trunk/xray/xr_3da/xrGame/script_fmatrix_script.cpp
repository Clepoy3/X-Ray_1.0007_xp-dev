...
//			.def("transform_tiny23",			&Fmatrix::transform_tiny23)
			.def("transform_tiny",				(void	   (Fmatrix::*)(Fvector &) const)(&Fmatrix::transform_tiny),											pure_out_value(_2))
			.def("transform_tiny",				(void	   (Fmatrix::*)(Fvector &, const Fvector &) const)(&Fmatrix::transform_tiny),							pure_out_value(_2))
//			.def("transform_dir",				(void	   (Fmatrix::*)(Fvector &) const)(&Fmatrix::transform_dir),												pure_out_value(_2))
//			.def("transform_dir",				(void	   (Fmatrix::*)(Fvector &, const Fvector &) const)(&Fmatrix::transform_dir),							pure_out_value(_2))
//			.def("transform",					(void	   (Fmatrix::*)(Fvector &) const)(&Fmatrix::transform),													pure_out_value(_2))
//			.def("transform",					&matrix_transform)
			.def("setHPB",						&Fmatrix::setHPB,																								return_reference_to(_1))
//			.def("setXYZ",						(Fmatrix & (Fmatrix::*)(Fvector &))(&Fmatrix::setXYZ),															return_reference_to(_1) + pure_out_value(_2))
			.def("setXYZ",						(Fmatrix & (Fmatrix::*)(float, float, float))(&Fmatrix::setXYZ),												return_reference_to(_1))
//			.def("setXYZi",						(Fmatrix & (Fmatrix::*)(Fvector &))(&Fmatrix::setXYZi),															return_reference_to(_1) + pure_out_value(_2))
			.def("setXYZi",						(Fmatrix & (Fmatrix::*)(float, float, float))(&Fmatrix::setXYZi),												return_reference_to(_1))
//			.def("getHPB",						(void	   (Fmatrix::*)(Fvector &) const)(&Fmatrix::getHPB),													pure_out_value(_2))
			.def("getHPB",						&get_matrix_hpb)
			.def("getRotation",					&get_matrix_rotation)
			.def("setRotation",					&set_matrix_rotation)
//			.def("getXYZ",						(void	   (Fmatrix::*)(Fvector &) const)(&Fmatrix::getXYZ),													pure_out_value(_2))
//			.def("getXYZ",						(void	   (Fmatrix::*)(float &, float &, float &) const)(&Fmatrix::getXYZ))
//			.def("getXYZi",						(void	   (Fmatrix::*)(Fvector &) const)(&Fmatrix::getXYZi),													pure_out_value(_2))
