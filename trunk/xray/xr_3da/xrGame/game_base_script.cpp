...
void game_PlayerState::script_register(lua_State *L)
{
	...
	module(L)
		[
			//class_<game_PlayerState, WrapType>("game_PlayerState")
			class_<game_PlayerState, no_bases, default_holder, WrapType>("game_PlayerState") //KRodin: попытка исправить эту фигню
			.def(constructor<>())
...
void game_GameState::script_register(lua_State *L)
{
	module(L)
		[
			class_< game_GameState, DLL_Pure >("game_GameState")
			.def(	constructor<>())
