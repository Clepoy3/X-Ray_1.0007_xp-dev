...
//#endif
		...
		ai().script_engine().script_log(ScriptStorage::eLuaMessageTypeError,"SCRIPT RUNTIME ERROR : evaluator [%s] returns value with not a bool type!", m_evaluator_name ? m_evaluator_name : "");
	}
	return false;
}
