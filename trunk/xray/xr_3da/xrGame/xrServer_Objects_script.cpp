...
{
	module(L)[
		class_<IPureLÓadableObject<IReader> >
			("ipure_alife_load_object"),
		class_<IPureSavableObject<IWriter> >
			("ipure_alife_save_object"),
		class_<IPureSerializeObject<IReader,IWriter>,bases<IPureLÓadableObject<IReader>,IPureSavableObject<IWriter> > > //KRodin: ÏÓÊÂÚ ÚÛÚ default_holder ‰Ó·‡‚ËÚ¸?
