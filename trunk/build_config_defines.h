...
//#define ECO_RENDER						// добавляет небольшую задержку между рендерингом кадров, чтобы зря не насиловать видеокарту при больших FPS //KRodin: после исправления вертикальной синхронизации, наверное, не нужно.
...
//#define SCRIPT_VARS_STORAGE				// включает хранилище скриптовых переменных в сейвы //KRodin: мне достаточно скриптового хранилища
...
//#define CAR_SAVE_FUEL					// Real Wolf: сохранение текущего объема топлива, максимального объема и потребления машины. //KRodin: НЕ ВКЛЮЧАТЬ! Вызывает проблемы с нет-пакетами машин
