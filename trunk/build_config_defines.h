...
//#define SCRIPT_VARS_STORAGE				// включает хранилище скриптовых переменных в сейвы //KRodin: хранилще выключено из за несовместимости с новым luabind'ом. В будущем может адаптирую.
